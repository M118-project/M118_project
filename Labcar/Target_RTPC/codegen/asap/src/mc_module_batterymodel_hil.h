...
struct Module_Batterymodel_HiL_Class
{
  ...
  scalarWrapper_Obj *MCWrapper_Batterymodel_HiL_P_zero_Value_Ptr;
  ...
  scalarWrapper_Obj *MCWrapper_Batterymodel_HiL_P_bat_voltageV_Gain_Ptr;
  ...
  scalarWrapper_Obj *MCWrapper_Batterymodel_HiL_B_bat_voltageV_Ptr;
