...
void isr_int3pie5_task_fcn(void)
{
  /* Call the system: <Root>/SoC_Estimation */
  {
    /* Output and update for function-call system: '<Root>/SoC_Estimation' */
    {
      ...
      /* MATLAB Function 'SoC_Estimation/Gesamtstrom Gesamtspannung1': '<S47>:1' */
      /*  This block supports the Embedded MATLAB subset. */
      /*  See the help menu for details.  */
      /* MATLAB Function 'SoC_Estimation/Extended Kalman Filter [mA] /  [mV]1': '<S46>:1' */
      /*  1) Initialization     */
      /*  Output SoC */
       ...
       */
      /* MATLAB Function 'SoC_Estimation/battery_current [mA] battery_voltage [mV]': '<S49>:1' */
...
void isr_int3pie3_task_fcn(void)
{
  /* Call the system: <Root>/Limit Monitoring Balancing */
  {
    /* Output and update for function-call system: '<Root>/Limit Monitoring Balancing' */
    {
       ...
       */
      /* MATLAB Function 'Limit Monitoring Balancing/limit monitoring [mV] / [K] / [mA]': '<S44>:1' */
       ...
       */
      /* MATLAB Function 'Limit Monitoring Balancing/balancing algorithm [mV]': '<S43>:1' */
      /*  balancing algorithm */
      /*  initialization */
      /*  Output */
      /* '<S43>:1:12' */
...
void isr_int3pie4_task_fcn(void)
{
  /* Call the system: <Root>/CAN-Transmit */
  {
    /* Output and update for function-call system: '<Root>/CAN-Transmit' */
    {
      ...
      /* msg_1 = uint32(error_code_in); */
      /* msg_2 = uint32(error_index_in);   */
      /* msg_3 = uint32(0); */
      /* msg_4 = uint32(error_in); */
      /* '<S33>:1:46' */
      /* '<S33>:1:47' */
      /* '<S33>:1:48' */
      /* '<S33>:1:49' */
      ...
      /* Outputs for Enabled SubSystem: '<S2>/CAN error' incorporates:
       *  EnablePort: '<S36>/Enable'
       */
      /* SignalConversion: '<S36>/TmpSignal ConversionAteCAN TransmitInport1' */
      Batman_Code_B.TmpSignalConversionAteCANTran_p[0] = rtb_can_low_0;
      Batman_Code_B.TmpSignalConversionAteCANTran_p[1] = rtb_can_high_0;

      /* S-Function Block: <S36>/eCAN Transmit (c280xcanxmt) */
      {
        ECanaMboxes.MBOX19.MDH.all =
          Batman_Code_B.TmpSignalConversionAteCANTran_p[1];
        ECanaMboxes.MBOX19.MDL.all =
          Batman_Code_B.TmpSignalConversionAteCANTran_p[0];
        ECanaMboxes.MBOX19.MSGCTRL.bit.DLC = 8;
        ECanaRegs.CANTRS.all = (((uint32_T) 0x00000001) << 19);
        EDIS;
      }

      /* End of Outputs for SubSystem: '<S2>/CAN error' */
      ...
      if (rtb_trig_2) {
        ...
        Batman_Code_B.TmpSignalConversionAteCANTran_o[0] = rtb_can_low_2;
        Batman_Code_B.TmpSignalConversionAteCANTran_o[1] = rtb_can_high_2;
      ...
      if (rtb_trig_3) {
        ...
        Batman_Code_B.TmpSignalConversionAteCANTransm[0] = rtb_can_low_3;
        Batman_Code_B.TmpSignalConversionAteCANTransm[1] = rtb_can_high_3;
...
void Batman_Code_initialize(void)
{
  ...
  /* S-Function Block: <S45>/MemCopy (memorycopy) */
  {
  ...
  /* Start for Enabled SubSystem: '<S2>/CAN error' */
  ...
  /* End of Start for SubSystem: '<S2>/CAN error' */
