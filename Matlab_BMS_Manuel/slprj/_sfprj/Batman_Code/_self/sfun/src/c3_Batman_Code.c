...
static const char * c3_debug_family_names[83] = { "msg", "error_in", "msg_1_1",
  "msg_1_2", "msg_5", "msg_6", "msg_7", "msg_8", "msg_2_1", "msg_2_2", "msg_9",
  "msg_10", "msg_11", "msg_12", "msg_3_1", "msg_3_2", "msg_4_1", "msg_4_2",
  "msg_5_1", "msg_5_2", "msg_6_1", "msg_6_2", "msg_7_1", "msg_7_2", "i",
  "msg_8_1", "msg_8_2", "msg_1", "msg_2", "msg_3", "msg_4", "msg_0_1", "msg_0_2",
  "error_code_in", "error_index_in", "nargin", "nargout", "cell_voltages_in",
  "cell_temperatures_in", "SoC_in", "voltage_in", "current_in", "balance_vec_in",
  "bat_mode", "error_index_in1", "error_index_in2", "error_index_in3",
  "error_index_in4", "error_index_in5", "error_index_in6", "error_index_in7",
  "error_index_in8", "lol1", "lol2", "CellNo", "trig_0", "can_low_0",
  "can_high_0", "trig_1", "can_low_1", "can_high_1", "trig_2", "can_low_2",
  "can_high_2", "trig_3", "can_low_3", "can_high_3", "trig_4", "can_low_4",
  "can_high_4", "trig_5", "can_low_5", "can_high_5", "trig_6", "can_low_6",
  "can_high_6", "trig_7", "can_low_7", "can_high_7", "trig_8", "can_low_8",
  "can_high_8", "timer" };
...
static const mxArray *c3_i_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_h_emlrt_marshallIn(SFc3_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c3_error_index_in, const char_T *c3_identifier);
static uint8_T c3_i_emlrt_marshallIn(SFc3_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint16_T c3_j_emlrt_marshallIn(SFc3_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_j_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_k_emlrt_marshallIn(SFc3_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
  ...
  (SFc3_Batman_CodeInstanceStruct *chartInstance)
{
  ...
  boolean_T c3_s_hoistedGlobal;
  boolean_T c3_s_u;
  const mxArray *c3_t_y = NULL;
  boolean_T c3_t_hoistedGlobal;
  boolean_T c3_t_u;
  ...
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellarray(29), FALSE);
  ...
  c3_cb_hoistedGlobal = chartInstance->c3_timer;
  ...
  if (!chartInstance->c3_timer_not_empty) {
    ...
    sf_mex_assign(&c3_db_y, sf_mex_create("y", &c3_cb_u, 3, 0U, 0U, 0U, 0),
                  FALSE);
  }

  sf_mex_setcell(c3_y, 27, c3_db_y);
  c3_db_hoistedGlobal = chartInstance->c3_is_active_c3_Batman_Code;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_trig_8 = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c3_timer = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 27)), "timer");
  chartInstance->c3_is_active_c3_Batman_Code = c3_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 28)),
...
static void sf_c3_Batman_Code(SFc3_Batman_CodeInstanceStruct *chartInstance)
{
  ...
  for (c3_i0 = 0; c3_i0 < 12; c3_i0++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c3_cell_voltages_in)[c3_i0], 0U);
  }

  for (c3_i1 = 0; c3_i1 < 12; c3_i1++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c3_cell_temperatures_in)[c3_i1], 1U);
  }

  _SFD_DATA_RANGE_CHECK((real_T)*c3_SoC_in, 2U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_voltage_in, 3U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_current_in, 4U);
  for (c3_i2 = 0; c3_i2 < 12; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*c3_balance_vec_in)[c3_i2], 5U);
  }

  _SFD_DATA_RANGE_CHECK((real_T)*c3_bat_mode, 6U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in1, 7U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in2, 8U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in3, 9U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in4, 10U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in5, 11U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in6, 12U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in7, 13U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_error_index_in8, 14U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_lol1, 15U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_lol2, 16U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_0, 17U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_0, 18U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_0, 19U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_1, 20U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_1, 21U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_1, 22U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_2, 23U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_2, 24U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_2, 25U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_3, 26U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_3, 27U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_3, 28U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_4, 29U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_4, 30U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_4, 31U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_5, 32U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_5, 33U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_5, 34U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_6, 35U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_6, 36U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_6, 37U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_7, 38U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_7, 39U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_7, 40U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_trig_8, 41U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_low_8, 42U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_can_high_8, 43U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_CellNo, 44U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  ...
  *chartInstance)
{
  ...
  uint8_T c3_error_index_in;
  real_T c3_nargin = 18.0;
  real_T c3_nargout = 27.0;
  boolean_T c3_trig_0;
  uint32_T c3_can_low_0;
  uint32_T c3_can_high_0;
  boolean_T c3_trig_1;
  ...
  sf_debug_symbol_scope_push_eml(0U, 83U, 84U, c3_debug_family_names,
    c3_debug_family_var_map);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg, 0U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c3_error_in, MAX_uint32_T, c3_h_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_1_1, 2U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_1_2, 3U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_5, 4U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_6, 5U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_7, 6U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_8, 7U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_2_1, 8U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_2_2, 9U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_9, 10U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_10, 11U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_11, 12U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_12, 13U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_3_1, 14U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_3_2, 15U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_4_1, 16U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_4_2, 17U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_5_1, 18U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_5_2, 19U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_6_1, 20U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_6_2, 21U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_7_1, 22U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_7_2, 23U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_i, 24U, c3_d_sf_marshallOut,
    c3_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_8_1, 25U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_8_2, 26U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_1, 27U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_2, 28U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_3, 29U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_4, 30U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_0_1, 31U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_msg_0_2, 32U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_error_code_in, 33U,
    c3_i_sf_marshallOut, c3_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_b_error_in, MAX_uint32_T,
    c3_i_sf_marshallOut, c3_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_error_index_in, 34U,
    c3_i_sf_marshallOut, c3_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_nargin, 35U, c3_h_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_nargout, 36U, c3_h_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c3_cell_voltages_in, 37U, c3_g_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c3_cell_temperatures_in, 38U,
    c3_g_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_SoC_in, 39U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_voltage_in, 40U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_current_in, 41U, c3_e_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c3_balance_vec_in, 42U, c3_f_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_bat_mode, 43U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in1, 44U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in2, 45U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in3, 46U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in4, 47U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in5, 48U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in6, 49U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in7, 50U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_error_index_in8, 51U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_lol1, 52U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_lol2, 53U, c3_e_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_CellNo, 54U, c3_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_0, 55U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_0, 56U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_0, 57U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_1, 58U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_1, 59U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_1, 60U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_2, 61U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_2, 62U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_2, 63U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_3, 64U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_3, 65U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_3, 66U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_4, 67U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_4, 68U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_4, 69U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_5, 70U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_5, 71U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_5, 72U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_6, 73U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_6, 74U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_6, 75U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_7, 76U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_7, 77U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_7, 78U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_trig_8, 79U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_low_8, 80U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_can_high_8, 81U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  ...
  CV_EML_IF(0, 1, 1, c3_error_in == 1.0);
  ...
  c3_b_error_in = 0U;
  sf_debug_symbol_switch(1U, 34U);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 59);
  c3_error_index_in = 0U;
  ...
  if (CV_EML_IF(0, 1, 10, (real_T)chartInstance->c3_timer == 8.0)) {
    ...
    while (c3_b_i <= c3_loop_ub) {
      ...
      if (CV_EML_IF(0, 1, 11, (real_T)c3_balance_vec_in[(uint16_T)
  ...
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -181);
  ...
  *chartInstance, const mxArray *c3_can_high_8, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_can_high_8),
    &c3_thisId);
  ...
  *chartInstance, const mxArray *c3_trig_8, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_trig_8), &c3_thisId);
  ...
  *chartInstance, const mxArray *c3_error_index_in, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_error_index_in),
    &c3_thisId);
  sf_mex_destroy(&c3_error_index_in);
  return c3_y;
}
...
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_error_index_in;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_y;
  SFc3_Batman_CodeInstanceStruct *chartInstance;
  chartInstance = (SFc3_Batman_CodeInstanceStruct *)chartInstanceVoid;
  c3_error_index_in = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_error_index_in),
  ...
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId)
{
  uint16_T c3_y;
  uint16_T c3_u10;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), &c3_u10, 1, 5, 0U, 0, 0U, 0);
  c3_y = c3_u10;
  sf_mex_destroy(&c3_u);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_i), &c3_thisId);
  sf_mex_destroy(&c3_i);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2237435854U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1689516752U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3342872322U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1424239235U);
}
...
mxArray *sf_c3_Batman_Code_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("11d0c4Tfy0Auf4IMrNKDaB");
...

  {
    ...
    mxArray *mxData = mxCreateStructMatrix(1,27,3,dataFields);
...
static const mxArray *sf_get_sim_state_info_c3_Batman_Code(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[6],T\"can_high_0\",},{M[1],M[13],T\"can_high_1\",},{M[1],M[17],T\"can_high_2\",},{M[1],M[20],T\"can_high_3\",},{M[1],M[66],T\"can_high_4\",},{M[1],M[69],T\"can_high_5\",},{M[1],M[72],T\"can_high_6\",},{M[1],M[75],T\"can_high_7\",},{M[1],M[78],T\"can_high_8\",},{M[1],M[5],T\"can_low_0\",}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[11],T\"can_low_1\",},{M[1],M[16],T\"can_low_2\",},{M[1],M[19],T\"can_low_3\",},{M[1],M[22],T\"can_low_4\",},{M[1],M[68],T\"can_low_5\",},{M[1],M[71],T\"can_low_6\",},{M[1],M[74],T\"can_low_7\",},{M[1],M[77],T\"can_low_8\",},{M[1],M[65],T\"trig_0\",},{M[1],M[7],T\"trig_1\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[14],T\"trig_2\",},{M[1],M[18],T\"trig_3\",},{M[1],M[21],T\"trig_4\",},{M[1],M[67],T\"trig_5\",},{M[1],M[70],T\"trig_6\",},{M[1],M[73],T\"trig_7\",},{M[1],M[76],T\"trig_8\",},{M[4],M[0],T\"timer\",S'l','i','p'{{M1x2[1056 1061],M[0],}}},{M[8],M[0],T\"is_active_c3_Batman_Code\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(_Batman_CodeMachineNumber_,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"cell_voltages_in");
          _SFD_SET_DATA_PROPS(1,1,1,0,"cell_temperatures_in");
          _SFD_SET_DATA_PROPS(2,1,1,0,"SoC_in");
          _SFD_SET_DATA_PROPS(3,1,1,0,"voltage_in");
          _SFD_SET_DATA_PROPS(4,1,1,0,"current_in");
          _SFD_SET_DATA_PROPS(5,1,1,0,"balance_vec_in");
          _SFD_SET_DATA_PROPS(6,1,1,0,"bat_mode");
          _SFD_SET_DATA_PROPS(7,1,1,0,"error_index_in1");
          _SFD_SET_DATA_PROPS(8,1,1,0,"error_index_in2");
          _SFD_SET_DATA_PROPS(9,1,1,0,"error_index_in3");
          _SFD_SET_DATA_PROPS(10,1,1,0,"error_index_in4");
          _SFD_SET_DATA_PROPS(11,1,1,0,"error_index_in5");
          _SFD_SET_DATA_PROPS(12,1,1,0,"error_index_in6");
          _SFD_SET_DATA_PROPS(13,1,1,0,"error_index_in7");
          _SFD_SET_DATA_PROPS(14,1,1,0,"error_index_in8");
          _SFD_SET_DATA_PROPS(15,1,1,0,"lol1");
          _SFD_SET_DATA_PROPS(16,1,1,0,"lol2");
          _SFD_SET_DATA_PROPS(17,2,0,1,"trig_0");
          _SFD_SET_DATA_PROPS(18,2,0,1,"can_low_0");
          _SFD_SET_DATA_PROPS(19,2,0,1,"can_high_0");
          _SFD_SET_DATA_PROPS(20,2,0,1,"trig_1");
          _SFD_SET_DATA_PROPS(21,2,0,1,"can_low_1");
          _SFD_SET_DATA_PROPS(22,2,0,1,"can_high_1");
          _SFD_SET_DATA_PROPS(23,2,0,1,"trig_2");
          _SFD_SET_DATA_PROPS(24,2,0,1,"can_low_2");
          _SFD_SET_DATA_PROPS(25,2,0,1,"can_high_2");
          _SFD_SET_DATA_PROPS(26,2,0,1,"trig_3");
          _SFD_SET_DATA_PROPS(27,2,0,1,"can_low_3");
          _SFD_SET_DATA_PROPS(28,2,0,1,"can_high_3");
          _SFD_SET_DATA_PROPS(29,2,0,1,"trig_4");
          _SFD_SET_DATA_PROPS(30,2,0,1,"can_low_4");
          _SFD_SET_DATA_PROPS(31,2,0,1,"can_high_4");
          _SFD_SET_DATA_PROPS(32,2,0,1,"trig_5");
          _SFD_SET_DATA_PROPS(33,2,0,1,"can_low_5");
          _SFD_SET_DATA_PROPS(34,2,0,1,"can_high_5");
          _SFD_SET_DATA_PROPS(35,2,0,1,"trig_6");
          _SFD_SET_DATA_PROPS(36,2,0,1,"can_low_6");
          _SFD_SET_DATA_PROPS(37,2,0,1,"can_high_6");
          _SFD_SET_DATA_PROPS(38,2,0,1,"trig_7");
          _SFD_SET_DATA_PROPS(39,2,0,1,"can_low_7");
          _SFD_SET_DATA_PROPS(40,2,0,1,"can_high_7");
          _SFD_SET_DATA_PROPS(41,2,0,1,"trig_8");
          _SFD_SET_DATA_PROPS(42,2,0,1,"can_low_8");
          _SFD_SET_DATA_PROPS(43,2,0,1,"can_high_8");
          _SFD_SET_DATA_PROPS(44,1,1,0,"CellNo");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",497,-1,6846);
        _SFD_CV_INIT_EML_IF(0,1,0,1063,1080,-1,1106);
        _SFD_CV_INIT_EML_IF(0,1,1,1707,1725,2394,2416);
        _SFD_CV_INIT_EML_IF(0,1,2,2394,2416,-1,2416);
        _SFD_CV_INIT_EML_IF(0,1,3,2882,2897,-1,3353);
        _SFD_CV_INIT_EML_IF(0,1,4,3359,3374,-1,3741);
        _SFD_CV_INIT_EML_IF(0,1,5,3743,3758,-1,4138);
        _SFD_CV_INIT_EML_IF(0,1,6,4140,4155,-1,4629);
        _SFD_CV_INIT_EML_IF(0,1,7,4631,4646,-1,5029);
        _SFD_CV_INIT_EML_IF(0,1,8,5031,5046,-1,5438);
        _SFD_CV_INIT_EML_IF(0,1,9,5440,5455,-1,5880);
        _SFD_CV_INIT_EML_IF(0,1,10,5882,5897,-1,6504);
        _SFD_CV_INIT_EML_IF(0,1,11,6019,6046,6109,6188);
        _SFD_CV_INIT_EML_IF(0,1,12,6608,6622,-1,6743);
        _SFD_CV_INIT_EML_FOR(0,1,0,5992,6011,6196);
...

        {
          ...
          c3_cell_voltages_in = (uint16_T (*)[12])ssGetInputPortSignal
            (chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c3_cell_voltages_in);
          _SFD_SET_DATA_VALUE_PTR(1U, *c3_cell_temperatures_in);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_SoC_in);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_voltage_in);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_current_in);
          _SFD_SET_DATA_VALUE_PTR(5U, *c3_balance_vec_in);
          _SFD_SET_DATA_VALUE_PTR(6U, c3_bat_mode);
          _SFD_SET_DATA_VALUE_PTR(7U, c3_error_index_in1);
          _SFD_SET_DATA_VALUE_PTR(8U, c3_error_index_in2);
          _SFD_SET_DATA_VALUE_PTR(9U, c3_error_index_in3);
          _SFD_SET_DATA_VALUE_PTR(10U, c3_error_index_in4);
          _SFD_SET_DATA_VALUE_PTR(11U, c3_error_index_in5);
          _SFD_SET_DATA_VALUE_PTR(12U, c3_error_index_in6);
          _SFD_SET_DATA_VALUE_PTR(13U, c3_error_index_in7);
          _SFD_SET_DATA_VALUE_PTR(14U, c3_error_index_in8);
          _SFD_SET_DATA_VALUE_PTR(15U, c3_lol1);
          _SFD_SET_DATA_VALUE_PTR(16U, c3_lol2);
          _SFD_SET_DATA_VALUE_PTR(17U, c3_trig_0);
          _SFD_SET_DATA_VALUE_PTR(18U, c3_can_low_0);
          _SFD_SET_DATA_VALUE_PTR(19U, c3_can_high_0);
          _SFD_SET_DATA_VALUE_PTR(20U, c3_trig_1);
          _SFD_SET_DATA_VALUE_PTR(21U, c3_can_low_1);
          _SFD_SET_DATA_VALUE_PTR(22U, c3_can_high_1);
          _SFD_SET_DATA_VALUE_PTR(23U, c3_trig_2);
          _SFD_SET_DATA_VALUE_PTR(24U, c3_can_low_2);
          _SFD_SET_DATA_VALUE_PTR(25U, c3_can_high_2);
          _SFD_SET_DATA_VALUE_PTR(26U, c3_trig_3);
          _SFD_SET_DATA_VALUE_PTR(27U, c3_can_low_3);
          _SFD_SET_DATA_VALUE_PTR(28U, c3_can_high_3);
          _SFD_SET_DATA_VALUE_PTR(29U, c3_trig_4);
          _SFD_SET_DATA_VALUE_PTR(30U, c3_can_low_4);
          _SFD_SET_DATA_VALUE_PTR(31U, c3_can_high_4);
          _SFD_SET_DATA_VALUE_PTR(32U, c3_trig_5);
          _SFD_SET_DATA_VALUE_PTR(33U, c3_can_low_5);
          _SFD_SET_DATA_VALUE_PTR(34U, c3_can_high_5);
          _SFD_SET_DATA_VALUE_PTR(35U, c3_trig_6);
          _SFD_SET_DATA_VALUE_PTR(36U, c3_can_low_6);
          _SFD_SET_DATA_VALUE_PTR(37U, c3_can_high_6);
          _SFD_SET_DATA_VALUE_PTR(38U, c3_trig_7);
          _SFD_SET_DATA_VALUE_PTR(39U, c3_can_low_7);
          _SFD_SET_DATA_VALUE_PTR(40U, c3_can_high_7);
          _SFD_SET_DATA_VALUE_PTR(41U, c3_trig_8);
          _SFD_SET_DATA_VALUE_PTR(42U, c3_can_low_8);
          _SFD_SET_DATA_VALUE_PTR(43U, c3_can_high_8);
          _SFD_SET_DATA_VALUE_PTR(44U, c3_CellNo);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c3_Batman_Code(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_reusable_outputs(S,infoStruct,3,27);
    }
  ...
  ssSetChecksum0(S,(4114570491U));
  ssSetChecksum1(S,(3340086796U));
  ssSetChecksum2(S,(1016884977U));
  ssSetChecksum3(S,(3021486733U));
