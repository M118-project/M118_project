...
static void c8_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct *chartInstance,
  const mxArray *c8_b_balance_vec, const char_T *c8_identifier, real_T c8_y[12]);
...
static void c8_c_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct *chartInstance,
  const mxArray *c8_balance_vec_out, const char_T *c8_identifier, uint16_T c8_y
  [12]);
static void c8_d_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, uint16_T c8_y[12]);
...
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c8_b_CellNo, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_h_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_g_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_i_emlrt_marshallIn(SFc8_Batman_CodeInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
  ...
  *chartInstance)
{
  ...
  sf_mex_import_named("CellNo", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c8_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c8_CellNo = (uint8_T)c8_d0;
  ...
  (SFc8_Batman_CodeInstanceStruct *chartInstance)
{
  ...
  uint16_T (*c8_balance_vec_out)[12];
  c8_balance_vec_out = (uint16_T (*)[12])ssGetOutputPortSignal(chartInstance->S,
    1);
  c8_st = NULL;
  c8_st = NULL;
  c8_y = NULL;
  ...
  c8_b_y = NULL;
  sf_mex_assign(&c8_b_y, sf_mex_create("y", c8_u, 5, 0U, 1U, 0U, 2, 1, 12),
                FALSE);
  ...
  if (!chartInstance->c8_balance_vec_not_empty) {
    ...
    sf_mex_assign(&c8_c_y, sf_mex_create("y", c8_b_u, 0, 0U, 1U, 0U, 2, 1, 12),
                  FALSE);
  }
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  for (c8_i3 = 0; c8_i3 < 12; c8_i3++) {
    chartInstance->c8_balance_vec[c8_i3] = c8_dv0[c8_i3];
  }

  chartInstance->c8_is_active_c8_Batman_Code = c8_f_emlrt_marshallIn
...
static void sf_c8_Batman_Code(SFc8_Batman_CodeInstanceStruct *chartInstance)
{
  ...
  uint16_T c8_u0;
  int32_T c8_i9;
  uint16_T (*c8_b_balance_vec_out)[12];
  uint16_T (*c8_b_cell_voltage_in)[12];
  c8_b_balance_vec_out = (uint16_T (*)[12])ssGetOutputPortSignal
    (chartInstance->S, 1);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c8_nargout, 1U, c8_f_sf_marshallOut,
    c8_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c8_cell_voltage_in, 2U, c8_e_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c8_b_CellNo, 3U, c8_d_sf_marshallOut,
    c8_d_sf_marshallIn);
  ...
  for (c8_i7 = 0; c8_i7 < 12; c8_i7++) {
    chartInstance->c8_balance_vec[c8_i7] = 1.0;
  }

  chartInstance->c8_balance_vec_not_empty = TRUE;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 9);
  for (c8_i8 = 0; c8_i8 < 12; c8_i8++) {
    c8_d2 = chartInstance->c8_balance_vec[c8_i8];
    c8_d2 = c8_d2 < 0.0 ? muDoubleScalarCeil(c8_d2 - 0.5) : muDoubleScalarFloor
      (c8_d2 + 0.5);
    c8_d3 = c8_d2;
    if (c8_d3 < 65536.0) {
      if (c8_d3 >= 0.0) {
        c8_u0 = (uint16_T)c8_d3;
      } else {
        c8_u0 = 0U;
      }
    } else if (c8_d3 >= 65536.0) {
      c8_u0 = MAX_uint16_T;
    } else {
      c8_u0 = 0U;
    }

    c8_balance_vec_out[c8_i8] = c8_u0;
  }
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  for (c8_i10 = 0; c8_i10 < 12; c8_i10++) {
    c8_b_inData[c8_i10] = (*(real_T (*)[12])c8_inData)[c8_i10];
  }
  ...
  if (!chartInstance->c8_balance_vec_not_empty) {
    ...
    sf_mex_assign(&c8_y, sf_mex_create("y", c8_u, 0, 0U, 1U, 0U, 2, 1, 12),
                  FALSE);
  }
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[12])
{
  ...
  if (mxIsEmpty(c8_u)) {
    ...
    chartInstance->c8_balance_vec_not_empty = TRUE;
    sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv1, 1, 0, 0U, 1, 0U, 2, 1,
                  12);
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  for (c8_i13 = 0; c8_i13 < 12; c8_i13++) {
    (*(real_T (*)[12])c8_outData)[c8_i13] = c8_y[c8_i13];
  }
  ...
  *c8_inData)
{
  ...
  for (c8_i14 = 0; c8_i14 < 12; c8_i14++) {
    c8_b_inData[c8_i14] = (*(uint16_T (*)[12])c8_inData)[c8_i14];
  }
  ...
  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_create("y", c8_u, 5, 0U, 1U, 0U, 2, 1, 12), FALSE);
  sf_mex_assign(&c8_mxArrayOutData, c8_y, FALSE);
  return c8_mxArrayOutData;
}
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, uint16_T c8_y[12])
{
  uint16_T c8_uv1[12];
  int32_T c8_i16;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_uv1, 1, 5, 0U, 1, 0U, 2, 1, 12);
  for (c8_i16 = 0; c8_i16 < 12; c8_i16++) {
    c8_y[c8_i16] = c8_uv1[c8_i16];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  for (c8_i17 = 0; c8_i17 < 12; c8_i17++) {
    (*(uint16_T (*)[12])c8_outData)[c8_i17] = c8_y[c8_i17];
  }
  ...
  *chartInstance, const mxArray *c8_b_CellNo, const char_T *c8_identifier)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_CellNo),
    &c8_thisId);
  sf_mex_destroy(&c8_b_CellNo);
  return c8_y;
}
...
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  const mxArray *c8_b_CellNo;
  const char_T *c8_identifier;
  emlrtMsgIdentifier c8_thisId;
  uint8_T c8_y;
  SFc8_Batman_CodeInstanceStruct *chartInstance;
  chartInstance = (SFc8_Batman_CodeInstanceStruct *)chartInstanceVoid;
  c8_b_CellNo = sf_mex_dup(c8_mxArrayInData);
  c8_identifier = c8_varName;
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_CellNo),
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_nargout), &c8_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3738035317U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4242634864U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3363580896U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2175026734U);
}
...
mxArray *sf_c8_Batman_Code_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0uPC2oLtu57qlH1CleHVuC");
...
static const mxArray *sf_get_sim_state_info_c8_Batman_Code(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[6],T\"balance_vec_out\",},{M[4],M[0],T\"balance_vec\",S'l','i','p'{{M1x2[126 137],M[0],}}},{M[8],M[0],T\"is_active_c8_Batman_Code\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          dimVector[0]= 1;
          dimVector[1]= 12;
          _SFD_SET_DATA_COMPILED_PROPS(1,SF_UINT16,2,&(dimVector[0]),0,0,0,0.0,
...

        {
          uint16_T (*c8_cell_voltage_in)[12];
          uint16_T (*c8_balance_vec_out)[12];
          c8_balance_vec_out = (uint16_T (*)[12])ssGetOutputPortSignal
            (chartInstance->S, 1);
...
static void mdlSetWorkWidths_c8_Batman_Code(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(171859512U));
  ssSetChecksum1(S,(1014784137U));
  ssSetChecksum2(S,(3820330534U));
  ssSetChecksum3(S,(398265988U));
