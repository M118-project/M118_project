...
typedef struct {
  ...
  uint32_T TmpSignalConversionAteCANTran_i[2];
  uint32_T TmpSignalConversionAteCANTran_o[2];
  uint32_T TmpSignalConversionAteCANTra_o4[2];
...
typedef struct {
  const int16_T convert;               /* '<S46>/convert' */
 ...
 * '<S36>'  : 'Batman_Code/CAN-Transmit/CAN temp_1'
 * '<S37>'  : 'Batman_Code/CAN-Transmit/CAN temp_2'
 * '<S38>'  : 'Batman_Code/CAN-Transmit/CAN temp_3'
 * '<S39>'  : 'Batman_Code/CAN-Transmit/CAN volt_1'
 * '<S40>'  : 'Batman_Code/CAN-Transmit/CAN volt_2'
 * '<S41>'  : 'Batman_Code/CAN-Transmit/CAN volt_3'
 * '<S42>'  : 'Batman_Code/CAN-Transmit/error_indezes1'
 * '<S43>'  : 'Batman_Code/CAN-Transmit/error_indizes2'
 * '<S44>'  : 'Batman_Code/Limit Monitoring Balancing/balancing algorithm [mV]'
 * '<S45>'  : 'Batman_Code/Limit Monitoring Balancing/limit monitoring [mV] // [K] // [mA]'
 * '<S46>'  : 'Batman_Code/SoC_Estimation/Dummy'
 * '<S47>'  : 'Batman_Code/SoC_Estimation/Extended Kalman Filter [mA] //  [mV]1'
 * '<S48>'  : 'Batman_Code/SoC_Estimation/Gesamtstrom Gesamtspannung1'
 * '<S49>'  : 'Batman_Code/SoC_Estimation/SoC'
 * '<S50>'  : 'Batman_Code/SoC_Estimation/battery_current [mA] battery_voltage [mV]'
 */
